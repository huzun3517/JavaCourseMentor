package AhmetT._09_Recursive;

public class Recursive1 {
    /*
        AhmetBey.Recursive bir methodun kendisini cagirmasidir
    ...
    public static void main(String[] args) {
        ...
        normalMethod5();
        System.out.println("AhmetBey.Recursive Method");
        recursiveMethod5(0);
    }
    ...
    public static void recursiveMethod1(){
        String str = "AhmetT/_09_Recursive";
        System.out.println(str);
        recursiveMethod1();
    }
